...
var car3 = "hb20"; //console.log(car3);
...
console.log(person); //exepmlo de loop, Nesse caso abaixo o comando var, permite que o incremento do loop 'i' seja acessivel fora do scopo desse método, o que não faz sentido, pois queremos que ele seja acessivel somente dentro do metodo
//for (var i = 0; i < 10; i++) {
//console.log(i);
//}
//console.log(i);
